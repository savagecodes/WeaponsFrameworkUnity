...
public class WPAmmoComponent : WPBaseWeaponComponent
{
    ...
    [SerializeField] 
    protected int _maxCapacityPerCharge;
    [SerializeField] 
    protected bool _hasInfiniteAmmo;
    ...
    public override void Initialize(Weapon weapon)
    {
        ...
        _baseWeaponInstance.EventsComponent.EventSystem.SubscribeToEvent(WeaponEventsID.ON_AMMO_CONSUMED, x => { ConsumeAmmo((int)x[0]);});
    }
